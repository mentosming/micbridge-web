...
export const COPY: Record<Lang, Dict> = {
  zh: {
    ...
    macCard: { name: "macOS", desc: "已 Apple 公證,直接開到。macOS 14+。", cta: "下載 .dmg", hint: "拖入「應用程式」即用。" },
  ...
  en: {
    ...
    macCard: { name: "macOS", desc: "Apple-notarized, opens straight away. macOS 14+.", cta: "Download .dmg", hint: "Drag into Applications and launch." },
